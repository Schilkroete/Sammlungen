...
public class Reaktion extends AppCompatActivity implements Runnable, View.OnTouchListener, View.OnClickListener{
            ...
            if (reactNow) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        tv_now.setText(String.format("%.2f", reactionTime));
                    }
                });
            }
            try {
